...
#include "creUsuario.h" // Incluyo solamente la clase de Usuario por el tipo de relación porque como existe una relación......
    ...
    while(opcion < 7 && opcion > -1){ // Se hace uso de una función while para que el menú y las opciones se ciclen hasta que el usuario desee salir.
        ...
        menu();
          ...
          case 3:
              ...
              cout<<user.mostrarPaqueteT();
              cout<<user.mostrarPaqueteM();
